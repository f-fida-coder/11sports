export function footerTemplate(basePath = '') {
  return `
    <footer class="border-t border-fuchsia-500/20 bg-[#040c08]">
      <div class="mx-auto max-w-[1400px] px-4 py-10">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 class="mb-3 text-sm font-bold uppercase tracking-wide text-fuchsia-400">Products</h3>
          ...
          <div>
            <h3 class="mb-3 text-sm font-bold uppercase tracking-wide text-fuchsia-400">Information</h3>
          ...
          <div>
            <h3 class="mb-3 text-sm font-bold uppercase tracking-wide text-fuchsia-400">Support</h3>
          ...
          <div>
            <h3 class="mb-3 text-sm font-bold uppercase tracking-wide text-fuchsia-400">Legal</h3>
            <p class="muted text-sm">18+ only. Gambling can be addictive. Please play responsibly and only if legal in your jurisdiction.</p>
          </div>
        </div>

        <div class="mt-8 border-t border-fuchsia-500/20 pt-4 text-xs text-slate-400">
